...
class Envs:
    ...
    SGLANG_LOG_MOE_RUNTIME = EnvBool(False)
    SGLANG_LOG_MOE_RUNTIME_INTERVAL = EnvInt(64)
    SGLANG_LOG_MOE_RUNTIME_RANKS = EnvStr("")
    SGLANG_LOG_MOE_RUNTIME_TOP_EXPERTS = EnvInt(8)
